...
* [Jasminum](https://github.com/l0o0/jasminum) ⭐ 7,217 | 🐛 45 | 🌐 TypeScript | 📅 2026-09-02 - - A Zotero add-on to retrieve CNKI meta.
...
* [Better BibTeX for Zotero](https://github.com/retorquere/zotero-better-bibtex) ⭐ 7,123 | 🐛 47 | 🌐 TypeScript | 📅 2026-09-15 - - Make Zotero effective for us LaTeX holdouts.
...
* [Scite-zotero-plugin](https://github.com/scitedotai/scite-zotero-plugin) ⭐ 866 | 🐛 22 | 🌐 TypeScript | 📅 2026-02-02 - - Add citations from Scite to Zotero.
...
* [inciteful-zotero-plugin](https://github.com/inciteful-xyz/inciteful-zotero-plugin) ⭐ 293 | 🐛 5 | 🌐 TypeScript | 📅 2026-08-20 - - A Zotero plugin which integrates Inciteful.xyz.
...
* [Zotero-inspire](https://github.com/fkguo/zotero-inspire) ⭐ 235 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-13 - - Fetch publication information from INSPIRE-HEP and add it to Zotero.
...
* [Zotero Metadata Hunter](https://github.com/federicotorrielli/zotero-metadata-hunter) ⭐ 36 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-31 - - Finds missing DOIs and abstracts, replaces preprints with their published versions, and enriches sparse items with metadata from CrossRef, DBLP, Semantic Scholar, arXiv, PubMed, and OpenAlex.
...
* [zotero-style](https://github.com/MuiseDestiny/zotero-style) ⭐ 5,243 | 🐛 791 | 🌐 JavaScript | 📅 2026-06-07 - - Zotero plugin to provide ethereal Style.
...
* [Zotero-actions-tags](https://github.com/windingwind/zotero-actions-tags) ⭐ 2,819 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-24 - - Automatic tagging of items based on actions performed on them.
...
* [Zotero-reference](https://github.com/MuiseDestiny/zotero-reference) ⭐ 2,804 | 🐛 210 | 🌐 JavaScript | 📅 2026-03-27 - - PDF references add-on for Zotero.
...
* [Zutilo](https://github.com/wshanks/Zutilo) ⭐ 1,881 | 🐛 92 | 🌐 JavaScript | 📅 2026-09-07 - - Zotero plugin providing some additional editing features.
...
* [Zotero-format-metadata](https://github.com/northword/zotero-format-metadata) ⭐ 1,055 | 🐛 26 | 🌐 TypeScript | 📅 2026-09-09 - - Linter for Zotero to format item metadata.
...
* [Tara](https://github.com/l0o0/tara) ⭐ 472 | 🐛 6 | 🌐 TypeScript | 📅 2026-06-07 - - Zotero add-on for backup and restore preferences, add-ons, translators, styles, and locate between two machines.
...
* [Zotero-better-authors](https://github.com/github-young/zotero-better-authors) ⭐ 163 | 🐛 4 | 🌐 TypeScript | 📅 2026-09-14 - - Customize the display of author names in Zotero.
...
* [Zotero-Focused-Mode](https://github.com/dschaehi/Zotero-Focused-Mode) ⭐ 83 | 🐛 3 | 🌐 JavaScript | 📅 2026-09-02 - - Distraction-free workspace for focused reading.
...
* [Zotfile](https://github.com/jlegewie/zotfile) ⭐ 4,374 | 🐛 300 | 🌐 Java | 📅 2024-04-16 - - Zotero plugin to automatically rename, move, and attach PDFs (or other files) to Zotero items.
...
* [Zotmoov](https://github.com/wileyyugioh/zotmoov) ⭐ 1,513 | 🐛 42 | 🌐 JavaScript | 📅 2026-09-08 - - Zotero plugin to automatically move attachments and link them.
...
* [Zotero-attanger](https://github.com/MuiseDestiny/zotero-attanger) ⭐ 1,351 | 🐛 160 | 🌐 TypeScript | 📅 2026-08-23 - - Attachment Manager for Zotero.
...
* [Zoplicate](https://github.com/ChenglongMa/zoplicate) ⭐ 989 | 🐛 52 | 🌐 TypeScript | 📅 2026-09-14 - - Detect and manage duplicate items in Zotero.
...
* [Zotero Watch Folder](https://github.com/josesiqueira/zotero-watch-folder) ⭐ 44 | 🐛 11 | 🌐 JavaScript | 📅 2026-09-15 - - Zotero plugin to watch a folder and auto-import PDFs with metadata retrieval and content-hash deduplication, plus optional two-way collection-to-folder sync with recoverable safe-delete.
...
* [notero](https://github.com/dvanoni/notero) ⭐ 3,217 | 🐛 72 | 🌐 TypeScript | 📅 2026-08-20 - - Zotero plugin for syncing items and notes into Notion.
...
* [Obsidian-Zotlit](https://github.com/PKM-er/obsidian-zotlit) ⭐ 1,020 | 🐛 24 | 🌐 TypeScript | 📅 2026-09-15 - - ZotLit is a third-party project that aims to facilitate the integration between Obsidian.md and Zotero.
...
* [Zotero Addons](https://github.com/syt2/zotero-addons) ⭐ 1,730 | 🐛 9 | 🌐 TypeScript | 📅 2026-09-08 - - Zotero add-on to list and install add-ons in Zotero.
...
* [Zotero Better Notes](https://github.com/windingwind/zotero-better-notes) ⭐ 8,212 | 🐛 10 | 🌐 TypeScript | 📅 2026-08-24 - - Everything about note management in Zotero.
...
* [Zotero-OCR](https://github.com/UB-Mannheim/zotero-ocr) ⭐ 824 | 🐛 10 | 🌐 JavaScript | 📅 2026-09-09 - - OCR PDFs in Zotero.
...
* [Zotero-reading-list](https://github.com/Dominic-DallOsto/zotero-reading-list) ⭐ 574 | 🐛 18 | 🌐 TypeScript | 📅 2026-08-19 - - Keep track of whether you've read items in Zotero.
...
* [zotcite](https://github.com/jalvesaq/zotcite) ⭐ 279 | 🐛 1 | 🌐 Lua | 📅 2026-08-24 - - Neovim plugin for integration with Zotero.
...
* [Zotero Docling](https://github.com/max3925vats/zotero-docling) ⭐ 13 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-13 - - Convert PDF attachments to structured Markdown using the Docling document converter, with OCR and table extraction.
...
* [Zotero PDF translate](https://github.com/windingwind/zotero-pdf-translate) ⭐ 11,796 | 🐛 17 | 🌐 TypeScript | 📅 2026-08-27 - - Translate PDF, EPub, webpage, metadata, annotations, notes to the target language.
...
* [Awesome GPT](https://github.com/MuiseDestiny/zotero-gpt) ⭐ 7,402 | 🐛 247 | 🌐 TypeScript | 📅 2026-05-01 - - Zotero plugin to provide GPT backend into Zotero using API.
...
* [zotero-arxiv-daily](https://github.com/TideDra/zotero-arxiv-daily) ⭐ 5,946 | 🐛 63 | 🌐 Python | 📅 2026-09-01 - - Recommend new arxiv papers of your interest daily according to your Zotero libarary. .
...
* [Zotero-MCP](https://github.com/54yyyu/zotero-mcp) ⭐ 5,030 | 🐛 47 | 🌐 Python | 📅 2026-09-15 - - Connects your Zotero research library with Claude and other AI assistants via the Model Context Protocol.
...
* [PapersGPT](https://github.com/papersgpt/papersgpt-for-zotero) ⭐ 2,636 | 🐛 76 | 🌐 JavaScript | 📅 2026-09-11 - - The Ultimate Zotero AI Plugin.
...
* [Beaver](https://github.com/jlegewie/beaver-zotero/) ⭐ 252 | 🐛 39 | 🌐 TypeScript | 📅 2026-09-15 - - Academic research assistant with native Zotero integration. Instantly searches through all your documents and explains complex concepts as you read.
...
* [Nodus](https://github.com/Drakonis96/nodus) ⭐ 230 | 🐛 11 | 🌐 TypeScript | 📅 2026-09-15 - - Desktop research workspace that turns Zotero libraries into idea graphs, semantic search, gap analysis, and citation-grounded writing.
...
* [ZotSeek](https://github.com/introfini/ZotSeek) ⭐ 201 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-01 - - Zotero plugin to find similar papers by meaning, not just keywords. 100% local, no data leaves your machine.
