...
* [Jasminum](https://github.com/l0o0/jasminum) ⭐ 7,224 | 🐛 45 | 🌐 TypeScript | 📅 2026-09-02 - - A Zotero add-on to retrieve CNKI meta.
...
* [Better BibTeX for Zotero](https://github.com/retorquere/zotero-better-bibtex) ⭐ 7,128 | 🐛 47 | 🌐 TypeScript | 📅 2026-09-16 - - Make Zotero effective for us LaTeX holdouts.
...
* [Zotero-citation](https://github.com/MuiseDestiny/zotero-citation) ⭐ 1,277 | 🐛 82 | 🌐 TypeScript | 📅 2026-08-24 - - Make Zotero's citation in Word easier and clearer.
...
* [Scite-zotero-plugin](https://github.com/scitedotai/scite-zotero-plugin) ⭐ 866 | 🐛 24 | 🌐 TypeScript | 📅 2026-02-02 - - Add citations from Scite to Zotero.
...
* [zotero-style](https://github.com/MuiseDestiny/zotero-style) ⭐ 5,247 | 🐛 792 | 🌐 JavaScript | 📅 2026-06-07 - - Zotero plugin to provide ethereal Style.
...
* [Zotero-actions-tags](https://github.com/windingwind/zotero-actions-tags) ⭐ 2,822 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-24 - - Automatic tagging of items based on actions performed on them.
...
* [Zotero-reference](https://github.com/MuiseDestiny/zotero-reference) ⭐ 2,810 | 🐛 210 | 🌐 JavaScript | 📅 2026-03-27 - - PDF references add-on for Zotero.
...
* [Zotero-format-metadata](https://github.com/northword/zotero-format-metadata) ⭐ 1,055 | 🐛 27 | 🌐 TypeScript | 📅 2026-09-09 - - Linter for Zotero to format item metadata.
...
* [Zotero-Focused-Mode](https://github.com/dschaehi/Zotero-Focused-Mode) ⭐ 84 | 🐛 3 | 🌐 JavaScript | 📅 2026-09-02 - - Distraction-free workspace for focused reading.
...
* [Zotmoov](https://github.com/wileyyugioh/zotmoov) ⭐ 1,514 | 🐛 42 | 🌐 JavaScript | 📅 2026-09-08 - - Zotero plugin to automatically move attachments and link them.
...
* [Zoplicate](https://github.com/ChenglongMa/zoplicate) ⭐ 991 | 🐛 52 | 🌐 TypeScript | 📅 2026-09-14 - - Detect and manage duplicate items in Zotero.
...
* [Zotero Watch Folder](https://github.com/josesiqueira/zotero-watch-folder) ⭐ 45 | 🐛 11 | 🌐 JavaScript | 📅 2026-09-16 - - Zotero plugin to watch a folder and auto-import PDFs with metadata retrieval and content-hash deduplication, plus optional two-way collection-to-folder sync with recoverable safe-delete.
...
* [notero](https://github.com/dvanoni/notero) ⭐ 3,220 | 🐛 72 | 🌐 TypeScript | 📅 2026-08-20 - - Zotero plugin for syncing items and notes into Notion.
...
* [Obsidian-Zotlit](https://github.com/PKM-er/obsidian-zotlit) ⭐ 1,019 | 🐛 18 | 🌐 TypeScript | 📅 2026-09-16 - - ZotLit is a third-party project that aims to facilitate the integration between Obsidian.md and Zotero.
...
* [Zotero Addons](https://github.com/syt2/zotero-addons) ⭐ 1,734 | 🐛 9 | 🌐 TypeScript | 📅 2026-09-08 - - Zotero add-on to list and install add-ons in Zotero.
...
* [zotero-arxiv-workflow](https://github.com/AllanChain/zotero-arxiv-workflow) ⭐ 386 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-01 - - Zotero plugin to help you manage adding and updating papers from arXiv.
...
* [Zotero Better Notes](https://github.com/windingwind/zotero-better-notes) ⭐ 8,216 | 🐛 10 | 🌐 TypeScript | 📅 2026-08-24 - - Everything about note management in Zotero.
...
* [Zotero-OCR](https://github.com/UB-Mannheim/zotero-ocr) ⭐ 826 | 🐛 10 | 🌐 JavaScript | 📅 2026-09-09 - - OCR PDFs in Zotero.
...
* [Zotero-reading-list](https://github.com/Dominic-DallOsto/zotero-reading-list) ⭐ 576 | 🐛 13 | 🌐 TypeScript | 📅 2026-09-16 - - Keep track of whether you've read items in Zotero.
...
* [zotcite](https://github.com/jalvesaq/zotcite) ⭐ 278 | 🐛 1 | 🌐 Lua | 📅 2026-09-15 - - Neovim plugin for integration with Zotero.
...
* [Zotero PDF translate](https://github.com/windingwind/zotero-pdf-translate) ⭐ 11,808 | 🐛 17 | 🌐 TypeScript | 📅 2026-08-27 - - Translate PDF, EPub, webpage, metadata, annotations, notes to the target language.
...
* [Awesome GPT](https://github.com/MuiseDestiny/zotero-gpt) ⭐ 7,408 | 🐛 247 | 🌐 TypeScript | 📅 2026-05-01 - - Zotero plugin to provide GPT backend into Zotero using API.
...
* [zotero-arxiv-daily](https://github.com/TideDra/zotero-arxiv-daily) ⭐ 5,951 | 🐛 63 | 🌐 Python | 📅 2026-09-01 - - Recommend new arxiv papers of your interest daily according to your Zotero libarary. .
...
* [Zotero-MCP](https://github.com/54yyyu/zotero-mcp) ⭐ 5,040 | 🐛 48 | 🌐 Python | 📅 2026-09-15 - - Connects your Zotero research library with Claude and other AI assistants via the Model Context Protocol.
...
* [PapersGPT](https://github.com/papersgpt/papersgpt-for-zotero) ⭐ 2,639 | 🐛 76 | 🌐 JavaScript | 📅 2026-09-11 - - The Ultimate Zotero AI Plugin.
...
* [Beaver](https://github.com/jlegewie/beaver-zotero/) ⭐ 252 | 🐛 38 | 🌐 TypeScript | 📅 2026-09-16 - - Academic research assistant with native Zotero integration. Instantly searches through all your documents and explains complex concepts as you read.
...
* [Nodus](https://github.com/Drakonis96/nodus) ⭐ 238 | 🐛 9 | 🌐 TypeScript | 📅 2026-09-16 - - Desktop research workspace that turns Zotero libraries into idea graphs, semantic search, gap analysis, and citation-grounded writing.
...
* [seerai](https://github.com/dralkh/seerai) ⭐ 78 | 🐛 5 | 🌐 TypeScript | 📅 2026-07-09 - - Intelligent research assistant plugin for Zotero that integrates AI-powered chat, advanced search, and data extraction capabilities directly into your research workflow.
