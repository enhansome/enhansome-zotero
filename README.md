...
* [Jasminum](https://github.com/l0o0/jasminum) ⭐ 7,203 | 🐛 45 | 🌐 TypeScript | 📅 2026-09-02 - - A Zotero add-on to retrieve CNKI meta.
...
* [Better BibTeX for Zotero](https://github.com/retorquere/zotero-better-bibtex) ⭐ 7,110 | 🐛 45 | 🌐 TypeScript | 📅 2026-09-10 - - Make Zotero effective for us LaTeX holdouts.
...
* [inciteful-zotero-plugin](https://github.com/inciteful-xyz/inciteful-zotero-plugin) ⭐ 292 | 🐛 5 | 🌐 TypeScript | 📅 2026-08-20 - - A Zotero plugin which integrates Inciteful.xyz.
...
* [Zotero-pmcid-fetcher](https://github.com/retorquere/zotero-pmcid-fetcher) ⭐ 143 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-24 - - Fetch PMCID/PMID for items with a DOI.
...
* [zotero-style](https://github.com/MuiseDestiny/zotero-style) ⭐ 5,233 | 🐛 792 | 🌐 JavaScript | 📅 2026-06-07 - - Zotero plugin to provide ethereal Style.
...
* [Zotero-actions-tags](https://github.com/windingwind/zotero-actions-tags) ⭐ 2,813 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-24 - - Automatic tagging of items based on actions performed on them.
...
* [Zotero-format-metadata](https://github.com/northword/zotero-format-metadata) ⭐ 1,048 | 🐛 24 | 🌐 TypeScript | 📅 2026-09-09 - - Linter for Zotero to format item metadata.
...
* [Zotero-better-authors](https://github.com/github-young/zotero-better-authors) ⭐ 162 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-08 - - Customize the display of author names in Zotero.
...
* [Zotmoov](https://github.com/wileyyugioh/zotmoov) ⭐ 1,511 | 🐛 42 | 🌐 JavaScript | 📅 2026-09-08 - - Zotero plugin to automatically move attachments and link them.
...
* [Zotero-attanger](https://github.com/MuiseDestiny/zotero-attanger) ⭐ 1,346 | 🐛 160 | 🌐 TypeScript | 📅 2026-08-23 - - Attachment Manager for Zotero.
...
* [Zoplicate](https://github.com/ChenglongMa/zoplicate) ⭐ 983 | 🐛 51 | 🌐 TypeScript | 📅 2026-09-07 - - Detect and manage duplicate items in Zotero.
...
* [Zotero Watch Folder](https://github.com/josesiqueira/zotero-watch-folder) ⭐ 44 | 🐛 10 | 🌐 JavaScript | 📅 2026-09-10 - - Zotero plugin to watch a folder and auto-import PDFs with metadata retrieval and content-hash deduplication, plus optional two-way collection-to-folder sync with recoverable safe-delete.
...
* [notero](https://github.com/dvanoni/notero) ⭐ 3,213 | 🐛 72 | 🌐 TypeScript | 📅 2026-08-20 - - Zotero plugin for syncing items and notes into Notion.
...
* [Obsidian-Zotlit](https://github.com/PKM-er/obsidian-zotlit) ⭐ 1,014 | 🐛 24 | 🌐 TypeScript | 📅 2026-09-10 - - ZotLit is a third-party project that aims to facilitate the integration between Obsidian.md and Zotero.
...
* [Zotero Addons](https://github.com/syt2/zotero-addons) ⭐ 1,724 | 🐛 9 | 🌐 TypeScript | 📅 2026-09-08 - - Zotero add-on to list and install add-ons in Zotero.
...
* [Zotero Better Notes](https://github.com/windingwind/zotero-better-notes) ⭐ 8,195 | 🐛 10 | 🌐 TypeScript | 📅 2026-08-24 - - Everything about note management in Zotero.
...
* [Zotero-OCR](https://github.com/UB-Mannheim/zotero-ocr) ⭐ 821 | 🐛 10 | 🌐 JavaScript | 📅 2026-09-09 - - OCR PDFs in Zotero.
...
* [Zotero-markdb-connect](https://github.com/daeh/zotero-markdb-connect) ⭐ 678 | 🐛 12 | 🌐 TypeScript | 📅 2026-08-19 - - Zotero plugin that links your Markdown database to Zotero.
...
* [Zotero-reading-list](https://github.com/Dominic-DallOsto/zotero-reading-list) ⭐ 571 | 🐛 18 | 🌐 TypeScript | 📅 2026-08-19 - - Keep track of whether you've read items in Zotero.
...
* [Zotero PDF translate](https://github.com/windingwind/zotero-pdf-translate) ⭐ 11,751 | 🐛 17 | 🌐 TypeScript | 📅 2026-08-27 - - Translate PDF, EPub, webpage, metadata, annotations, notes to the target language.
...
* [Awesome GPT](https://github.com/MuiseDestiny/zotero-gpt) ⭐ 7,389 | 🐛 247 | 🌐 TypeScript | 📅 2026-05-01 - - Zotero plugin to provide GPT backend into Zotero using API.
...
* [zotero-arxiv-daily](https://github.com/TideDra/zotero-arxiv-daily) ⭐ 5,924 | 🐛 62 | 🌐 Python | 📅 2026-09-01 - - Recommend new arxiv papers of your interest daily according to your Zotero libarary. .
...
* [Zotero-MCP](https://github.com/54yyyu/zotero-mcp) ⭐ 4,974 | 🐛 87 | 🌐 Python | 📅 2026-08-25 - - Connects your Zotero research library with Claude and other AI assistants via the Model Context Protocol.
...
* [PapersGPT](https://github.com/papersgpt/papersgpt-for-zotero) ⭐ 2,632 | 🐛 75 | 🌐 JavaScript | 📅 2026-09-07 - - The Ultimate Zotero AI Plugin.
...
* [Beaver](https://github.com/jlegewie/beaver-zotero/) ⭐ 250 | 🐛 38 | 🌐 TypeScript | 📅 2026-09-10 - - Academic research assistant with native Zotero integration. Instantly searches through all your documents and explains complex concepts as you read.
...
* [ZotSeek](https://github.com/introfini/ZotSeek) ⭐ 198 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-01 - - Zotero plugin to find similar papers by meaning, not just keywords. 100% local, no data leaves your machine.
...
* [Nodus](https://github.com/Drakonis96/nodus) ⭐ 128 | 🐛 12 | 🌐 TypeScript | 📅 2026-09-10 - - Desktop research workspace that turns Zotero libraries into idea graphs, semantic search, gap analysis, and citation-grounded writing.
...
* [zotero-night](https://github.com/tefkah/zotero-night) ⭐ 2,455 | 🐛 93 | 🌐 SCSS | 📅 2026-04-24 - - Night theme for Zotero UI and PDF.
