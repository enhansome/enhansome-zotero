...
* [Jasminum](https://github.com/l0o0/jasminum) ⭐ 7,148 | 🐛 44 | 🌐 TypeScript | 📅 2026-06-03 - - A Zotero add-on to retrieve CNKI meta.
...
* [Better BibTeX for Zotero](https://github.com/retorquere/zotero-better-bibtex) ⭐ 7,038 | 🐛 39 | 🌐 TypeScript | 📅 2026-08-12 - - Make Zotero effective for us LaTeX holdouts.
...
* [Zotero DOI Manager](https://github.com/bwiernik/zotero-shortdoi) ⭐ 1,632 | 🐛 31 | 🌐 JavaScript | 📅 2024-08-10 - - Zotero plugin to retrieve and manage DOIs for references.
...
* [Zotero-citation](https://github.com/MuiseDestiny/zotero-citation) ⭐ 1,274 | 🐛 81 | 🌐 TypeScript | 📅 2026-08-17 - - Make Zotero's citation in Word easier and clearer.
...
* [Zotero-citationcounts](https://github.com/eschnett/zotero-citationcounts) ⭐ 931 | 🐛 29 | 🌐 JavaScript | 📅 2023-11-09 - - Zotero plugin for auto-fetching citation counts from various sources.
...
* [Scite-zotero-plugin](https://github.com/scitedotai/scite-zotero-plugin) ⭐ 859 | 🐛 22 | 🌐 TypeScript | 📅 2026-02-02 - - Add citations from Scite to Zotero.
...
* [inciteful-zotero-plugin](https://github.com/inciteful-xyz/inciteful-zotero-plugin) ⭐ 286 | 🐛 5 | 🌐 TypeScript | 📅 2026-05-11 - - A Zotero plugin which integrates Inciteful.xyz.
...
* [Zotero-inspire](https://github.com/fkguo/zotero-inspire) ⭐ 233 | 🐛 5 | 🌐 TypeScript | 📅 2026-08-18 - - Fetch publication information from INSPIRE-HEP and add it to Zotero.
...
* [Zotero-pmcid-fetcher](https://github.com/retorquere/zotero-pmcid-fetcher) ⭐ 141 | 🐛 1 | 🌐 TypeScript | 📅 2026-07-06 - - Fetch PMCID/PMID for items with a DOI.
...
* [Zotero TL;DR](https://github.com/syt2/Zotero-TLDR) ⚠️ Archived - - Zotero addon to automatically fetch TL;DR from Semantic Scholar for items.
...
* [cite-non-english](https://github.com/boan-anbo/cite-non-english) ⭐ 33 | 🐛 7 | 🌐 TypeScript | 📅 2026-05-06 - - Zotero extension to provide all-in-one support for non-English citations.
...
* [Zotero Metadata Hunter](https://github.com/federicotorrielli/zotero-metadata-hunter) ⭐ 31 | 🐛 0 | 🌐 TypeScript | 📅 2026-06-22 - - Finds missing DOIs and abstracts, replaces preprints with their published versions, and enriches sparse items with metadata from CrossRef, DBLP, Semantic Scholar, arXiv, PubMed, and OpenAlex.
...
* [zotero-style](https://github.com/MuiseDestiny/zotero-style) ⭐ 5,197 | 🐛 784 | 🌐 JavaScript | 📅 2026-06-07 - - Zotero plugin to provide ethereal Style.
...
* [Zotero-reference](https://github.com/MuiseDestiny/zotero-reference) ⭐ 2,798 | 🐛 210 | 🌐 JavaScript | 📅 2026-03-27 - - PDF references add-on for Zotero.
...
* [Zotero-actions-tags](https://github.com/windingwind/zotero-actions-tags) ⭐ 2,782 | 🐛 3 | 🌐 TypeScript | 📅 2026-05-27 - - Automatic tagging of items based on actions performed on them.
...
* [Zutilo](https://github.com/wshanks/Zutilo) ⭐ 1,866 | 🐛 91 | 🌐 JavaScript | 📅 2026-07-20 - - Zotero plugin providing some additional editing features.
...
* [Zotero-pdf-preview](https://github.com/windingwind/zotero-pdf-preview) ⚠️ Archived - - Preview Zotero attachments in the library view.
...
* [Zotero-format-metadata](https://github.com/northword/zotero-format-metadata) ⭐ 1,027 | 🐛 23 | 🌐 TypeScript | 📅 2026-08-14 - - Linter for Zotero to format item metadata.
...
* [Delitemwithatt](https://github.com/redleafnew/delitemwithatt) ⭐ 657 | 🐛 4 | 🌐 TypeScript | 📅 2026-08-10 - - Remove attachment(s) when deleting the item(s) or collection in Zotero and JurisM.
...
* [Tara](https://github.com/l0o0/tara) ⭐ 469 | 🐛 6 | 🌐 TypeScript | 📅 2026-06-07 - - Zotero add-on for backup and restore preferences, add-ons, translators, styles, and locate between two machines.
...
* [Zotero-better-authors](https://github.com/github-young/zotero-better-authors) ⭐ 159 | 🐛 3 | 🌐 TypeScript | 📅 2026-08-19 - - Customize the display of author names in Zotero.
...
* [Zotero-date-from-last-modified](https://github.com/retorquere/zotero-date-from-last-modified) ⭐ 122 | 🐛 1 | 🌐 TypeScript | 📅 2026-06-24 - - Shows when the item was last modified.
...
* [Zotero-Focused-Mode](https://github.com/dschaehi/Zotero-Focused-Mode) ⭐ 77 | 🐛 3 | 🌐 JavaScript | 📅 2026-07-18 - - Distraction-free workspace for focused reading.
...
* [MCP Server Zotero Dev](https://github.com/introfini/mcp-server-zotero-dev) ⭐ 37 | 🐛 3 | 🌐 TypeScript | 📅 2026-08-17 - - MCP server paired with a bridge plugin that exposes a running Zotero over the Remote Debugging Protocol for AI-assisted plugin development (run JS, inspect DOM, read logs, hot-reload).
...
* [Zotmoov](https://github.com/wileyyugioh/zotmoov) ⭐ 1,484 | 🐛 42 | 🌐 JavaScript | 📅 2026-08-18 - - Zotero plugin to automatically move attachments and link them.
...
* [Zotero-attanger](https://github.com/MuiseDestiny/zotero-attanger) ⭐ 1,331 | 🐛 159 | 🌐 TypeScript | 📅 2026-07-28 - - Attachment Manager for Zotero.
...
* [Zoplicate](https://github.com/ChenglongMa/zoplicate) ⭐ 961 | 🐛 47 | 🌐 TypeScript | 📅 2026-08-19 - - Detect and manage duplicate items in Zotero.
...
* [Zotero-storage-scanner](https://github.com/retorquere/zotero-storage-scanner) ⚠️ Archived - - Zotero plugin to remove the broken & duplicate attachment links of the bibliography.
...
* [Zotero-open-pdf](https://github.com/retorquere/zotero-open-pdf) ⭐ 262 | 🐛 7 | 🌐 TypeScript | 📅 2026-06-24 - - Open PDFs in external PDF viewer from Zotero.
...
* [Zotero Watch Folder](https://github.com/josesiqueira/zotero-watch-folder) ⭐ 38 | 🐛 9 | 🌐 JavaScript | 📅 2026-08-19 - - Zotero plugin to watch a folder and auto-import PDFs with metadata retrieval and content-hash deduplication, plus optional two-way collection-to-folder sync with recoverable safe-delete.
...
* [notero](https://github.com/dvanoni/notero) ⭐ 3,197 | 🐛 71 | 🌐 TypeScript | 📅 2026-08-19 - - Zotero plugin for syncing items and notes into Notion.
...
* [Obsidian-Zotlit](https://github.com/PKM-er/obsidian-zotlit) ⭐ 994 | 🐛 24 | 🌐 TypeScript | 📅 2026-08-19 - - ZotLit is a third-party project that aims to facilitate the integration between Obsidian.md and Zotero.
...
* [lyz](https://github.com/wshanks/lyz) ⭐ 117 | 🐛 10 | 🌐 JavaScript | 📅 2021-09-06 - - Zotero plugin intended to make working with LyX/Zotero more pleasant.
...
* [Zotero Addons](https://github.com/syt2/zotero-addons) ⭐ 1,682 | 🐛 7 | 🌐 TypeScript | 📅 2026-08-14 - - Zotero add-on to list and install add-ons in Zotero.
...
* [zotero-arxiv-workflow](https://github.com/AllanChain/zotero-arxiv-workflow) ⭐ 379 | 🐛 4 | 🌐 TypeScript | 📅 2026-08-19 - - Zotero plugin to help you manage adding and updating papers from arXiv.
...
* [KeepZotero](https://github.com/yhmtsai/KeepZotero) ⭐ 82 | 🐛 1 | 🌐 JavaScript | 📅 2025-04-13 - - Zotero plugin to keep Zotero in the taskbar by changing close to minimize or disabling shortcuts.
...
* [Zotero Better Notes](https://github.com/windingwind/zotero-better-notes) ⭐ 8,101 | 🐛 13 | 🌐 TypeScript | 📅 2026-08-02 - - Everything about note management in Zotero.
...
* [Zotero mdnotes](https://github.com/argenos/zotero-mdnotes) ⚠️ Archived - - Zotero plugin to export item metadata and notes as markdown files.
...
* [Zotero-OCR](https://github.com/UB-Mannheim/zotero-ocr) ⭐ 813 | 🐛 11 | 🌐 JavaScript | 📅 2026-06-04 - - OCR PDFs in Zotero.
...
* [Zotero-markdb-connect](https://github.com/daeh/zotero-markdb-connect) ⭐ 675 | 🐛 12 | 🌐 TypeScript | 📅 2026-07-22 - - Zotero plugin that links your Markdown database to Zotero.
...
* [Zotcard](https://github.com/018/zotcard) ⭐ 642 | 🐛 55 | 🌐 JavaScript | 📅 2025-06-03 - - Card note-taking enhancement tool with card templates.
...
* [Zotero-reading-list](https://github.com/Dominic-DallOsto/zotero-reading-list) ⭐ 564 | 🐛 18 | 🌐 TypeScript | 📅 2026-08-18 - - Keep track of whether you've read items in Zotero.
...
* [Chartero](https://github.com/volatile-static/Chartero) ⭐ 514 | 🐛 31 | 🌐 Vue | 📅 2026-04-22 - - Zotero plugin to provide charts in Zotero.
...
* [zotxt](https://github.com/egh/zotxt) ⭐ 379 | 🐛 12 | 🌐 JavaScript | 📅 2026-08-11 - - Zotero extension for supporting utilities that deal with plain text files.
...
* [zotcite](https://github.com/jalvesaq/zotcite) ⭐ 274 | 🐛 0 | 🌐 Lua | 📅 2026-08-19 - - Neovim plugin for integration with Zotero.
...
* [cmp-zotcite](https://github.com/jalvesaq/cmp-zotcite) ⚠️ Archived - - Zotero completion source for nvim-cmp using zotcite as backend.
...
* [Zotero Docling](https://github.com/max3925vats/zotero-docling) ⭐ 11 | 🐛 5 | 🌐 TypeScript | 📅 2026-08-11 - - Convert PDF attachments to structured Markdown using the Docling document converter, with OCR and table extraction.
...
* [Zotero PDF translate](https://github.com/windingwind/zotero-pdf-translate) ⭐ 11,578 | 🐛 20 | 🌐 TypeScript | 📅 2026-08-18 - - Translate PDF, EPub, webpage, metadata, annotations, notes to the target language.
...
* [Awesome GPT](https://github.com/MuiseDestiny/zotero-gpt) ⭐ 7,344 | 🐛 247 | 🌐 TypeScript | 📅 2026-05-01 - - Zotero plugin to provide GPT backend into Zotero using API.
...
* [zotero-arxiv-daily](https://github.com/TideDra/zotero-arxiv-daily) ⭐ 5,836 | 🐛 61 | 🌐 Python | 📅 2026-08-03 - - Recommend new arxiv papers of your interest daily according to your Zotero libarary. .
...
* [Zotero-MCP](https://github.com/54yyyu/zotero-mcp) ⭐ 4,712 | 🐛 59 | 🌐 Python | 📅 2026-08-13 - - Connects your Zotero research library with Claude and other AI assistants via the Model Context Protocol.
...
* [PapersGPT](https://github.com/papersgpt/papersgpt-for-zotero) ⭐ 2,600 | 🐛 75 | 🌐 JavaScript | 📅 2026-08-13 - - The Ultimate Zotero AI Plugin.
...
* [Aria](https://github.com/lifan0127/ai-research-assistant) ⭐ 1,723 | 🐛 103 | 🌐 JavaScript | 📅 2025-04-01 - - Aria is Your AI Research Assistant for zotero.
...
* [Beaver](https://github.com/jlegewie/beaver-zotero/) ⭐ 234 | 🐛 36 | 🌐 TypeScript | 📅 2026-08-19 - - Academic research assistant with native Zotero integration. Instantly searches through all your documents and explains complex concepts as you read.
...
* [ZotSeek](https://github.com/introfini/ZotSeek) ⭐ 187 | 🐛 5 | 🌐 TypeScript | 📅 2026-08-19 - - Zotero plugin to find similar papers by meaning, not just keywords. 100% local, no data leaves your machine.
...
* [Nodus](https://github.com/Drakonis96/nodus) ⭐ 78 | 🐛 8 | 🌐 TypeScript | 📅 2026-08-19 - - Desktop research workspace that turns Zotero libraries into idea graphs, semantic search, gap analysis, and citation-grounded writing.
...
* [seerai](https://github.com/dralkh/seerai) ⭐ 76 | 🐛 4 | 🌐 TypeScript | 📅 2026-07-09 - - Intelligent research assistant plugin for Zotero that integrates AI-powered chat, advanced search, and data extraction capabilities directly into your research workflow.
...
* [zotero-night](https://github.com/tefkah/zotero-night) ⭐ 2,455 | 🐛 94 | 🌐 SCSS | 📅 2026-04-24 - - Night theme for Zotero UI and PDF.
